<#include "../public_header.ftl">
    ...
    <link rel="stylesheet" href="/static/css/domesticAddress/edit.css">
	<script type="text/javascript" src="/static/js/domesticAddress/edit.js"></script>
...
<div class="zq-body">
    ...
    <form class="layui-form layui-form-pane zq-form">
        <input type="hidden" value="${chinaAreaId}" name="chinaAreaId">
