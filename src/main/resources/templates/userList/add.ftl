<#include "../public_header.ftl">
	<script type="text/javascript" src="/static/js/userList/add.js"></script>
	...
	<div class="zq-body">
		<form class="layui-form zq-form">
            ...
            <div class="layui-col-md6 zq-col-bottom">
                ...
                <div class="layui-col-md8">
                    <input type="password" class="layui-input queren-password" autocomplete="off" lay-verify="required"/>
                </div>
            </div>
