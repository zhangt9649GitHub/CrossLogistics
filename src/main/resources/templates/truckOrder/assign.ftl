<#include "../public_header.ftl">
	...
	<script type="text/javascript" src="/static/js/truckOrder/assign.js"></script>
    ...
    <form class="layui-form layui-form-pane zq-form">
        ...
        <div class="layui-form-item">
            <label  for="name" class="layui-form-label">
                <@spring.message code="truckOrder_truckdriver"/>
            </label>
            <div class="layui-input-inline" >
                <select name="newAppUserId" lay-filter="aihao" lay-verify="required" lay-search>
                    <option value=""></option>
