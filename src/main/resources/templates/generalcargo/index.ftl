...
<#include "../public_header.ftl">
	...
	<script type="text/javascript" src="/static/js/generalcargo/index.js"></script>
...
<body class="zq-bodybagcolor">
	...
	<div class="zq-body">
		...
		<div class="zq-actionbuttons">
            ...
            <#if insertOrdinaryGoods??>
                <button class="layui-btn" onclick="zq_admin_show('新增','/admin/generalcargo/add')"><i class="layui-icon">&#xe608;</i>新增</button>
            </#if>
        </div>
		<!-- 操作按钮 end-->
	...
	<script type="text/html" id="barDemo">
        ...
        <#if getOrdinaryGoodsById??>
            <a class="zq-btn-open"  onclick="zq_admin_show('查看','/admin/generalcargo/open?goodsId={{d.goodsId}}')">查看</a>
        </#if>

        <#if deleteOrdinaryGoodsById??>
