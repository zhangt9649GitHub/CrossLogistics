$(document).ready(function(){
    ...
    layui.use(['layer', 'form','table','laydate'], function(){
        ...
        form.on('submit(add)', function(data){
            ...
            axios.post("/appUser/editAppUser", data.field)
    	...
    	// 获取编辑信息
		$.ajax({
			url: '/appUser/selectEditAppUserDetail',
			dataType: 'JSON',
			...
			success: function (data) {
				if(data.data != null){
                    ...
                    $('input[name="actualName"]').val(data.data.actualName);
                    $('input[name="houseNumber"]').val(data.data.houseNumber);
