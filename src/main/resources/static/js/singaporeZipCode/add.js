$(document).ready(function(){
    ...
    layui.use(['layer', 'form','table'], function(){
        ...
        form.on('submit(add)', function(data){
            ...
            var msg = active.yanzhengbianhao(data.field.saZipCode);
            if(msg){
            ...
            axios.post("/sgBuilding/addSGBuilding", data.field)
        ...
        var active = {
            yanzhengbianhao : function (saZipCode) {
                var msg;
                $.ajax({
                    url: '/sgBuilding/checkZipCode',
                    type: 'post',
                    data: {'saZipCode': saZipCode},
                    async: false,
