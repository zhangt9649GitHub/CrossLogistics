...
<#include "../public_header.ftl">
	...
	<script type="text/javascript" src="/static/js/carOrderStatistics/index.js"></script>
    ...
    <div class="zq-query-body" style="display: none" id="zq-query">
        <form class="layui-form  layui-form-pane zq-query-form">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" name="sendPeople" autocomplete="off" class="layui-input">
                </div>
            </div>
            <div class="layui-form-item">
