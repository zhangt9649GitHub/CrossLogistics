...
public class JuHeUtil {
    ...
    //配置您申请的KEY
    public static final String APPKEY ="5a5ba5995ed22f476a36a894653e2a8d";//5a5ba5995ed22f476a36a894653e2a8d

    public static final String opAPPKEY ="5a5ba5995ed22f476a36a894653e2a8d";
    ...
    public static void getRequest3(){
        ...
        params.put("key",opAPPKEY);//应用APPKEY(应用详细页查询)
