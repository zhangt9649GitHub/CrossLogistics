$(document).ready(function(){
	...
	layui.use(['layer', 'form','table','upload','laydate'], function(){
        ...
        table.render({
            elem: '#idTest'
            ,height: 500
            ,url: "/statistics/getAppUserTruckStatistics"//数据接口
            ,page: true
            ,method: 'post'
            ,cellMinWidth:80
            ,cols: [[
                ...
                ,{field: 'userTrueName', title: '司机姓名',align:'center'}
                ...
                ,{field: 'isReceiveGoods', title: '接受状态',align:'center',templet:'#isReceiveGoods'}
        ...
        var startDate='',endDate='',userTrueName='';
        ...
        $('#export').click(function(){
            ...
            location.href="/statistics/getTruckStatisticsFile?startDate"+startDate+"&endDate="+endDate+"&userTrueName="+userTrueName;
        });
