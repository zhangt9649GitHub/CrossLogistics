...
<script type="text/javascript" src="/static/js/truckMission/add.js"></script>
	...
	<div class="zq-body">
		<form class="layui-form zq-form">
            ...
            <div class="layui-col-md12 zq-col-bottom">
                ...
                <div class="layui-col-md8">
                    <select name="truckDriverId" xm-select="select2" lay-verify="required" class="truckDriverId" lay-search>
